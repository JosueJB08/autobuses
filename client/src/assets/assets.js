...
export const cityList = ['Querétaro', 'Ciudad de México', 'Guadalajara', 'Monterrey']
...
export const menuLinks = [
    { name: "Inicio", path: "/" },
    { name: "Vehículo", path: "/cars" },
    { name: "Mis Reservaciones", path: "/my-bookings" },
]

export const ownerMenuLinks = [
    { name: "Dashboard", path: "/owner", icon: dashboardIcon, coloredIcon: dashboardIconColored },
    { name: "Agregar vehículo", path: "/owner/add-car", icon: addIcon, coloredIcon: addIconColored },
    { name: "Administrar vehículos", path: "/owner/manage-cars", icon: carIcon, coloredIcon: carIconColored },
    { name: "Administrar reservas", path: "/owner/manage-bookings", icon: listIcon, coloredIcon: listIconColored },
]

export const dummyUserData = {
  "_id": "6847f7cab3d8daecdb517095",
  "name": "JosueJB",
  "email": "josuejaimejb@gmail.com",
  "role": "owner",
  "image": user_profile,
}
