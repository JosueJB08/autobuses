  ...
  return (
    ...
    className='px-6 md:px-16 lg:px-24 xl:px-32 2xl:px-48 mt-16 text-sm max-w-7xl'>
      ...
      <Title title='Mis Reservas'
       subTitle='Ve y administra tus reservaciones aquí'
       align="left"/>
          ...
          key={booking._id} className='grid grid-cols-1 md:grid-cols-4 gap-6 p-6 border border-borderColor rounded-lg mt-5 first:mt-12'>
            ...
            <div className='md:col-span-2'>
              <div className='flex items-center gap-2'>
                <p className='px-3 py-1.5 bg-light rounded'>Reservación #{index+1}</p>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  <p className='text-gray-500'>Periodo de renta</p>
              ...
              <div className='flex items-start gap-2 mt-3'>
                ...
                <div>
                  <p className='text-gray-500'>Localización</p>
