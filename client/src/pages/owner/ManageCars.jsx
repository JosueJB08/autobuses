...
const ManageCars = () => {
  ...
  return (
    <div className='px-4 pt-10 md:px-10 w-full'>
      ...
      <Title title="Gestionar Autos" subTitle="Ver todos los autos listados, actualiza sus detalles o elimínalos de la plataforma de reservas."/>
        ...
        <table className='w-full border-collapse text-left text-sm text-gray-600'>
          <thead className='text-gray-500'>
            <tr>
              ...
              <th className="p-3 font-medium max-md:hidden">Categoría</th>
          ...
          <tbody>
            {cars.map((car, index)=>(
              <tr key={index} className='border-t border-borderColor'>
                ...
                <td className='p-3'>{currency}{car.pricePerDay}/día</td>
