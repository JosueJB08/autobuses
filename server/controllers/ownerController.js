...
export const changeRoleToOwner = async (req, res)=>{
    try {
        ...
        res.json({success: true, message: "Ahora puedes añadir vehículos"})
    } catch (error) {
...
export const addCar = async (req, res)=>{
    try {
        ...
        res.json({success: true, message: "Vehículo añadido"})
...
export const getDashboardData = async (req, res) =>{
    try {
        ...
        const completedBookings = await Booking.find({owner: _id, status: "confirmado" })
